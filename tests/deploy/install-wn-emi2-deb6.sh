...
apt-get -y install openmpi-devel openmpi-bin mpich2 mpich-bin libmpich2-dev  libmpich1.0-dev lam-dev  lam-runtime
...
echo "** emi-wn"
apt-get -y install glite-yaim-clients gawk fetch-crl
